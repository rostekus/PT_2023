...
internal class StaticLibraryDataContextGenerator : IDataContextGenerator
{
    public LibraryDataContext Generate()
    {
        ...
        libraryContext.Books.Add("1", new Book("Harry Pother", "Rowling", "1"));
        libraryContext.Books.Add("2", new Book("The Lord of the Rings", "J.R.R. Tolkien", "2"));
        libraryContext.Books.Add("3", new Book("To Kill a Mockingbird", "Harper Lee", "3"));
